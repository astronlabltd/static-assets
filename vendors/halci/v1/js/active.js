...
$(document).ready(function() {
	...
	$(window).on('scroll', function () {
	    if ($(this).scrollTop() > 10) {
	        ...
	        $('.mobile-header').removeClass("position-relative");
	        $('.mobile-header').addClass("position-fixed");
	    } else {
	        fixed_top.removeClass("menu-fixed fadeInDown");
	        fixed_top.addClass("slideInUp"); 
	        $('body').removeClass("body-padding");
	        $('.mobile-header').removeClass("position-fixed");
	        $('.mobile-header').addClass("position-relative");
	...
	$(window).on("scroll", function () {
	    if ($(this).scrollTop() > 200) {
	        ...
	        // // $('.scrollToTop').fadeIn();
	        // // $('.scrollToTop').delay(2000).hide();
	        $('.scrollToTop').stop().fadeOut(2000);
